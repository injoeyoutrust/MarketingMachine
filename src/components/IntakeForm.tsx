  ...
  return (
    <div className="mt-5 rounded-xl border border-neutral-200 bg-white p-5 dark:border-neutral-800 dark:bg-neutral-900">
      ...
      <p className="mt-0.5 text-xs text-neutral-400 dark:text-neutral-500">
        ...
        guess at. More detail means fewer flags, not a requirement.
      </p>
      <textarea
        value={idea}
...
export function IntakeForm({
  ...
  return (
    <div className="mx-auto max-w-3xl pb-16">
        ...
        <div className="mx-auto flex max-w-3xl items-center justify-between gap-4">
          <div>
            ...
            <p className="text-xs text-neutral-500 dark:text-neutral-400">
              {mode === "quick"
                ? "Quick idea — the engine fills gaps with flags, not guesses."
      ...
      {mode === "quick" ? (
        <QuickIdeaPanel idea={quickIdea} onIdeaChange={onQuickIdeaChange} />
      ) : (
