  ...
  return (
    <div className="mx-auto max-w-3xl pb-16">
      ...
      <p className="mt-1 text-sm text-neutral-500 dark:text-neutral-400">
        ...
        angle selected. Pick one funnel style to shape the opt-in and thank-you pages, and one VSL style
        for the centerpiece video (used only if the chosen funnel style actually includes a VSL).
      </p>
